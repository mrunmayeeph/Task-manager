        ...
        {task && (
          ...
          <div className='form-card col-span-3'>
            <div className='flex items-center justify-between'>
              <h2 className='text-sm md:text-xl fotn-medium'>
                {task?.title}
              </h2>
            ...
            <div className='mt-4'>
              <InfoBox label ="Descritption" value={task?.description}/>
            </div>
            ...
            <div className='grid grid-cols-12 gap-4 mt-4'>
              ...
              <div className="col-span md:col-span-4">
                <label className='text-xs fnt-medium text-slate-500'>
                  Assigned To
                </label>
...
const TodoCheckList = ({text, isChecked, onChange}) => {
  return <div className='flex items-center gap-3 p-3'>
    <input
      ...
      checked={isChecked}
      onChange={onChange}
      className='w-4 h4 text-blue-500 bg-gray-100 border-gray-300 rounded-sm outline-none cursor-pointer'
    />
